...
python3 -u main.py --name deq-flow-H-chairs --stage chairs --validation chairs \
...
python3 -u main.py --name deq-flow-H-things --stage things \
...
python3 -u main.py --name deq-flow-H-sintel --stage sintel \
...
python3 -u main.py --name deq-flow-H-kitti --stage kitti \
